...
contract placePixel is ERC721URIStorage {
    ...
    address public arbitrator = 0x728cBa71A3723cAAb33ea416cb46e2Cc9215A596; // realitio kleros with appeals on gnosis chain
    RealityETH_v3_0 public reality = RealityETH_v3_0(0x5b7dD1E86623548AF054A4985F7fc8Ccbb554E2c);
    ...
    function lock(uint16 _x, uint16 _y, uint16 _xx, uint16 _yy) external payable returns(bytes32 quesitonID){
        ...
        bytes32 questionID = reality.askQuestion(54, question, arbitrator, challengePeriod, 0, block.timestamp);
